...
export function CallDetailsDialog({ callId, open, onOpenChange, children }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {children}
      <DialogContent className="xl:max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        {callData && !loading && !error && (
          <div className="flex-1 overflow-y-auto space-y-4 pr-2">
            ...
            {/* Transcription - This section is scrollable */}
            <div className="flex-shrink-0">
              <h3 className="font-semibold text-lg mb-2">📝 Diarized Transcription</h3>
              <Separator className="mb-3" />
              
              {/* Scrollable transcription area with max height */}
            ...
            {callData.segments && callData.segments.length === 0 && (
              <div className="p-3 bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded text-xs flex-shrink-0">
